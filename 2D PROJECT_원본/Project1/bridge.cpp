...
HRESULT bridge::init()
{
	IMAGEMANAGER->addImage("maxBridge", "image/map/maxBridge.bmp", WINSIZEX, WINSIZEY, true, RGB(255,0,255));
	IMAGEMANAGER->addImage("maxBridge2", "image/map/maxBridge2.bmp", WINSIZEX, WINSIZEY, true, RGB(255, 0, 255));
...
void bridge::render(HDC hdc)
{
	...
	//	
	//}
	//rc = RectMake(m_PosX + m_bridgeDestX[4], m_bridgeDestY, 10, 10);
	//rc2 = RectMake(m_PosX + m_bridgeDestX[0], m_bridgeDestY + 120, 10, 10);
