...
HRESULT player::init()
{
	...
	//m_upper.pAni->init(UPPER_AppearWidth, UPPER_AppearHeight, UPPER_AppearWidth / UPPER_AppearFrame, UPPER_AppearHeight, UPPER_AppearY);	// UPPER_Appear
	...
	/*m_upper.rc = RectMake(m_upper.pImg->getX(), m_upper.pImg->getY(), m_upper.pAni->getFrameWidth(), m_upper.pAni->getFrameHeight());
	m_lower.rc = RectMake(m_lower.pImg->getX(), m_lower.pImg->getY(), m_lower.pAni->getFrameWidth(), m_lower.pAni->getFrameHeight());*/
	...
	m_nActUpper = UPPER_Sit;	// 테스트용
	m_nActLower = LOWER_NULL;	// 테스트용
	m_nDir = DIR_Right;
	m_isAct = true;				// 테스트용 (기존 false)
...
void player::move()
{
	...
	m_upper.rc = RectMake(m_upper.pImg->getX(), m_upper.pImg->getY(),
		m_upper.pAni->getFrameWidth(), m_upper.pAni->getFrameHeight());

	// 하체 위치 업데이트
	if (m_nDir == DIR_Left)
	{
		m_lower.pImg->setY(m_upper.pImg->getY());
		m_lower.rc = RectMake(m_upper.rc.right, m_lower.pImg->getY() + m_lower.pAni->getFrameHeight() + m_fReplaceY,
			m_lower.pAni->getFrameWidth(), m_lower.pAni->getFrameHeight());
	}
	else
	{
		m_lower.pImg->setY(m_upper.pImg->getY());
